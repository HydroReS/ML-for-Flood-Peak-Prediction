############################################################################################################################################
# LOCAL - LightGBM algorithm - Models trained on 10 hydroclimatic, unique regions in CONUS LOCAL Dataset

# CONUS
IMG_CONUS_01 = {'max_leaf_nodes': 57, 'max_iter': 40, 'l2_regularization': 38.02877518906046, 'learning_rate': 0.40856976142428353, 'validation_fraction': 0.1}
...
# CH-Models trained on 4 hydroclimatic, unique regions in Switzerland (CH) global precipitation datasets; Local Dataset
